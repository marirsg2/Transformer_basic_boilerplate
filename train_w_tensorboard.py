...
def train(model: nn.Module, epoch: int) -> None:
    ...
    for batch, i in enumerate(range(0, train_data.size(0) - 1, bptt)):
        ...
        if batch % log_interval == 0 and batch > 0:
            ...
            writer.add_scalar("Training/Loss", cur_loss, epoch * num_batches + batch)
            writer.add_scalar("Training/PPL", ppl, epoch * num_batches + batch)
            writer.add_scalar("Training/LR", lr, epoch * num_batches + batch)
...
writer.add_scalar("Test/PPL", test_ppl)
